...
- **LAN Configuration Object (10535)** - Full LAN network management
  - Interface configuration (IP, DHCP, DNS)
  - DHCP server management
  - UCI configuration persistence
- **Routing Table Object (10536)** - Static and dynamic routing
  - IPv4/IPv6 dual-stack support
  - Policy-based routing
  - Multi-table routing (main, local, custom)
  - Route state monitoring
- **VPN Configuration Object (10537)** - Multi-protocol VPN management
...
- **WAN Failover Policy Object (10525)** - Multi-WAN failover management
  - mwan3 integration for OpenWRT
  - Failover, load-balance, and round-robin modes
  - Weight-based traffic distribution
  - Policy-based routing rules
  - Automatic failover/failback
- **Multi-WAN Health Check Object (10526)** - WAN health monitoring
...
- **WiFi Client Management Object (10527)** - Connected client management
  ...
  - hostapd integration
- **WiFi Channel Optimization Object (10528)** - Channel management
...
- **Matter Bridge Object (10529)** - Controller management
- **Matter Device Object (10530)** - Device instance management
- **Thread Network Object (10531)** - Thread BR configuration
...
- **Zigbee Coordinator Object (10532)** - Network management
- **Zigbee Device Object (10533)** - Device management
- **Zigbee Group Object (10534)** - Group control

#### OMA Registry XML Files
- 10525.xml - WAN Failover Policy
- 10526.xml - Multi-WAN Health Check
- 10527.xml - WiFi Client Management
- 10528.xml - WiFi Channel Optimization
- 10529.xml - Matter Bridge
- 10530.xml - Matter Device
- 10531.xml - Thread Network
- 10532.xml - Zigbee Coordinator
- 10533.xml - Zigbee Device
- 10534.xml - Zigbee Group
- 10535.xml - LAN Configuration
- 10536.xml - Routing Table
- 10537.xml - VPN Configuration
...
| 10525 | WAN Failover Policy | 1.2.0 |
| 10526 | Multi-WAN Health Check | 1.2.0 |
| 10527 | WiFi Client Management | 1.2.0 |
| 10528 | WiFi Channel Optimization | 1.2.0 |
| 33440 | prplMesh | 1.2.0 |
| 10529 | Matter Bridge | 1.2.0 |
| 10530 | Matter Device | 1.2.0 |
| 10531 | Thread Network | 1.2.0 |
| 10532 | Zigbee Coordinator | 1.2.0 |
| 10533 | Zigbee Device | 1.2.0 |
| 10534 | Zigbee Group | 1.2.0 |
| 10535 | LAN Configuration | 1.2.0 |
| 10536 | Routing Table | 1.2.0 |
| 10537 | VPN Configuration | 1.2.0 |
