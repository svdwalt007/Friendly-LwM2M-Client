...
All Walt Technologies LwM2M objects have been renumbered from the temporary 34600-10537 range to the permanent 10512-10537 range to comply with OMA LwM2M object ID allocation standards.
...
| Old ID | New ID | Object Name | Directory | Type |
|--------|--------|-------------|-----------|------|
| 10525 | **10525** | WAN Failover Policy | `w_10525_wan_failover_policy` | Walt Tech |
| 10526 | **10526** | Multi-WAN Health Check | `w_10526_multiwan_health_check` | Walt Tech |
| 10527 | **10527** | WiFi Client Management | `w_10527_wifi_client_management` | Walt Tech |
| 10528 | **10528** | WiFi Channel Optimization | `w_10528_wifi_channel_optimization` | Walt Tech |
| 10529 | **10529** | Matter Bridge | `w_10529_matter_bridge` | Walt Tech |
| 10530 | **10530** | Matter Device | `w_10530_matter_device` | Walt Tech |
| 10531 | **10531** | Thread Network | `w_10531_thread_network` | Walt Tech |
| 10532 | **10532** | Zigbee Coordinator | `w_10532_zigbee_coordinator` | Walt Tech |
| 10533 | **10533** | Zigbee Device | `w_10533_zigbee_device` | Walt Tech |
| 10534 | **10534** | Zigbee Group | `w_10534_zigbee_group` | Walt Tech |
| 10535 | **10535** | LAN Configuration | `w_10535_lan_configuration` | Walt Tech |
| 10536 | **10536** | Routing Table | `w_10536_routing_table` | Walt Tech |
| 10537 | **10537** | VPN Configuration | `w_10537_vpn_configuration` | Walt Tech |
...
- ❌ **Not backward compatible** - old object IDs (34600-10537) are no longer supported
