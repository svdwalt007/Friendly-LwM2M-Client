...
# Include optional WLAN Connectivity object in the build (DISABLED - incompatible structure)
# set(WPP_DEFINITIONS ${WPP_DEFINITIONS} OBJ_O_12_WLAN_CONNECTIVITY)
# Include optional Bearer Selection object in the build (DISABLED - incompatible structure)
...
# Walt Technologies Object ID Range: 10512-10537
# Include Walt Technologies Starlink Terminal object in the build (Object ID: 10512) (DISABLED - incompatible API)
# set(WPP_DEFINITIONS ${WPP_DEFINITIONS} OBJ_O_10512_STARLINK_TERMINAL)
# Include Walt Tech Router Management object in the build (Object ID: 10513) (DISABLED - incompatible structure)
# set(WPP_DEFINITIONS ${WPP_DEFINITIONS} OBJ_W_10513_ROUTER_MANAGEMENT)
# Include Walt Tech Ethernet Interface object in the build (Object ID: 10514) (DISABLED - incompatible structure)
# set(WPP_DEFINITIONS ${WPP_DEFINITIONS} OBJ_W_10514_ETHERNET_INTERFACE)
# Include Walt Tech GPIO Control object in the build (Object ID: 10515) (DISABLED - incompatible structure)
# set(WPP_DEFINITIONS ${WPP_DEFINITIONS} OBJ_W_10515_GPIO_CONTROL)
# Include Walt Tech USB Management object in the build (Object ID: 10516) (DISABLED - incompatible structure)
# set(WPP_DEFINITIONS ${WPP_DEFINITIONS} OBJ_W_10516_USB_MANAGEMENT)
# Include Walt Tech Storage Management object in the build (Object ID: 10517) (DISABLED - incompatible structure)
# set(WPP_DEFINITIONS ${WPP_DEFINITIONS} OBJ_W_10517_STORAGE_MANAGEMENT)
# Include Walt Tech System Monitor object in the build (Object ID: 10518) (DISABLED - incompatible structure)
# set(WPP_DEFINITIONS ${WPP_DEFINITIONS} OBJ_W_10518_SYSTEM_MONITOR)
# Include Walt Tech Hardware Watchdog object in the build (Object ID: 10519) (DISABLED - incompatible API)
# set(WPP_DEFINITIONS ${WPP_DEFINITIONS} OBJ_O_10519_HARDWARE_WATCHDOG)
# Include Walt Tech MIKROBUS object in the build (Object ID: 10520) (DISABLED - incompatible API)
# set(WPP_DEFINITIONS ${WPP_DEFINITIONS} OBJ_O_10520_MIKROBUS)
# Include Walt Tech Firewall Configuration object in the build (Object ID: 10521) (DISABLED - incompatible structure)
# set(WPP_DEFINITIONS ${WPP_DEFINITIONS} OBJ_W_10521_FIREWALL_CONFIG)
# Include Walt Tech PoE Management object in the build (Object ID: 10522) (DISABLED - incompatible structure)
