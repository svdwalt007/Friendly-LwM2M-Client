/*
 * WifiClientManagement (Object 33422)
 * Walt Technologies - OpenWRT One Router
 *
 * WiFi Client Management for connected clients monitoring and control
 */

#ifndef WPP_W_33422_WIFI_CLIENT_MANAGEMENT_H
#define WPP_W_33422_WIFI_CLIENT_MANAGEMENT_H
...
public:
    ...
    /* Instance lifecycle */
    WifiClientManagement(Object& object, INST_T instId);
    ~WifiClientManagement() override;

    /* Public methods */
    void updateClientStats();
    static void enumerateClients(WppClient& client);
...
#endif // WPP_W_33422_WIFI_CLIENT_MANAGEMENT_H
