/*
 * ZigbeeCoordinator (Object 10532)
...
#ifndef WPP_W_10532_ZIGBEE_COORDINATOR_H
#define WPP_W_10532_ZIGBEE_COORDINATOR_H
...
public:
    ...
    static ZigbeeCoordinator* createInst(WppClient& ctx, ID_T instId = 0);
    static ZigbeeCoordinator* instance(WppClient& ctx, ID_T instId = ID_T_MAX_VAL);
    static bool removeInst(WppClient& ctx, ID_T instId);

    /* Instance lifecycle */
    ZigbeeCoordinator(lwm2m_context_t& context, const OBJ_LINK_T& id);
    ~ZigbeeCoordinator();
...
#endif // WPP_W_10532_ZIGBEE_COORDINATOR_H
