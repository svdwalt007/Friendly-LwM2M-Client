...
public:
    ...
    static LanConfiguration* createInst(WppClient& ctx, ID_T instId = ID_T_MAX_VAL);
    static LanConfiguration* instance(WppClient& ctx, ID_T instId);
    static bool removeInst(WppClient& ctx, ID_T instId);

    /* Instance lifecycle */
    LanConfiguration(lwm2m_context_t& context, const OBJ_LINK_T& id);
    ~LanConfiguration();
