/*
 * MultiWanHealthCheck (Object 10526)
 * Walt Technologies - OpenWRT One Router
 *
 * Multi-WAN Health Check and Probing for WAN interfaces
 */

#ifndef WPP_W_10526_MULTIWAN_HEALTH_CHECK_H
#define WPP_W_10526_MULTIWAN_HEALTH_CHECK_H
...
public:
    ...
    static MultiWanHealthCheck* createInst(WppClient& ctx, ID_T instId = ID_T_MAX_VAL);
    static MultiWanHealthCheck* instance(WppClient& ctx, ID_T instId = ID_T_MAX_VAL);
    static bool removeInst(WppClient& ctx, ID_T instId);

    /* Instance lifecycle */
    MultiWanHealthCheck(lwm2m_context_t& context, const OBJ_LINK_T& id);
    ~MultiWanHealthCheck();
...
#endif // WPP_W_10526_MULTIWAN_HEALTH_CHECK_H
