/*
 * WifiChannelOptimization (Object 10528)
 * Walt Technologies - OpenWRT One Router
 *
 * WiFi Channel Optimization and Automatic Channel Selection for OpenWRT
 */

#ifndef WPP_W_10528_WIFI_CHANNEL_OPTIMIZATION_H
#define WPP_W_10528_WIFI_CHANNEL_OPTIMIZATION_H
...
public:
    ...
    static WifiChannelOptimization* createInst(WppClient& ctx, ID_T instId = ID_T_MAX_VAL);
    static WifiChannelOptimization* instance(WppClient& ctx, ID_T instId);
    static bool removeInst(WppClient& ctx, ID_T instId);

    /* Instance lifecycle */
    WifiChannelOptimization(lwm2m_context_t& context, const OBJ_LINK_T& id);
...
private:
/* Resource setup methods */    void resourcesCreate();    void resourcesInit();
    /* Private methods */
...
#endif // WPP_W_10528_WIFI_CHANNEL_OPTIMIZATION_H
